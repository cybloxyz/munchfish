...
#define OLED_SDA 8   // dipindah dari GPIO8 -> bentrok sama LED biru onboard
#define OLED_SCK 9   // dipindah dari GPIO9
...
void drawEye(int cx, int cy, float w, float h) {
  display.fillRoundRect(cx - w/2, cy - h/2, w, h, 6, SSD1306_WHITE);
}

void drawMouth() {
  int mouthH = mouthOpen ? 14 : 4;
  display.fillRoundRect(50, 46, 28, mouthH, 3, SSD1306_WHITE);
}
